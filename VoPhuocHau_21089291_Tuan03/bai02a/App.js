...
export default function App() {
  return (
   <View style={styles.container}>
    ...
    <Image style={styles.image} source={require('icons8-amazon-kindle-50.png')}/>
    </View>
    <TextInput style={styles.textInput} placeholder="Name" />
    </View>
    <View style={styles.textInputContainer} >  
    <View style={styles.imageContainer,{paddingTop:10,paddingLeft:15}}>
    <Image style={styles.image,{height:25,width:25}} source={require('Remove-bg.ai_1727280933343.png')}/>
    </View>
    <TextInput style={styles.textInput} placeholder="Password" />
    <View style={styles.imageContainer,{paddingTop:15,paddingRight:10}}>
    <Image style={styles.image,{height:15,width:30}} source={require('eye.png')}/>
    </View>   
    </View>
    </View>
    <View>
    ...
    <View>
      <TouchableOpacity >CREATE ACCOUNT</TouchableOpacity>
    </View>
   </View>
  );
}
